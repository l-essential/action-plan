...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class=""></i> {{ trans('master.form') }} Program Kegiatan
        </h1>
                ...
                <div class="dropdown">
                    <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                          <li>
                            <a class="dropdown-item" href="{{ url('admin/rekers') }}">View by List</a>
                          </li>
                          <li>
                              <a class="dropdown-item" href="{{ url('admin/rekers?mode_view=card') }}">View by Card</a>
                          </li>                  
                      </ul>
                </div>
            </div>
                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                                    ...
                                    <div class="col-sm-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="department_id" class="form-control selectpicker" data-live-search="true">
                                                @if( \ModelInit::canIAccess('browse_all_' . $objReker->getTable()) === false )
                                                    @php
                        ...
                        @if( app('request')->input('mode_view') == 'card' )
                            @include('vendor/voyager/rekers.browse-card')
                        @else
                            @include('vendor/voyager/rekers.browse-table')
                        @endif
...
@section('javascript')
    ...
    <script>
        ...
        $('td').on('click', '.delete', function (e) {
            $('#delete_form')[0].action = 'rekers/__id'.replace('__id', $(this).data('id'));
