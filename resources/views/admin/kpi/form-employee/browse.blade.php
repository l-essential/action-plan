...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class=""></i> {{ trans('master.form') .' '. trans('master.kpi_personal') }}
        </h1>

        
            <a href="{{ url('admin/kpi/form-employee/create') }}" class="btn btn-success btn-add-new">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    @foreach ($form_kpi_employees as $key => $item)
                                        <tr>
                                            <td> 
                                                (
                                            ...
                                            <td>
                                                <a href="{{ url("admin/kpi/form-employee/detail?id=". $item->id) }}" class="btn btn-sm btn-warning">
                                                    <i class="voyager-eye"></i> Lihat
                                                </a>

                                                <a href="{{ url("admin/kpi/form-employee/edit?id=". $item->id) }}" class="btn btn-sm btn-primary">
                                                    <i class="voyager-edit"></i> Ubah
                                                </a>

                                                <a href="javascript:void(0);" title="Batal" class="btn btn-sm btn-danger pull-right delete" data-id="{{ $item->id }}" id="delete-kpi-form-employee-{{ $item->id }}">
