<div id="accordion-level">
    ...
    ?>
        ...
        <div class="card">
            ...
            <div id="c-poiuy-<?php echo $key; ?>" class="{{ $key == 0 ? 'collapse in' : 'collapse' }}" data-parent="#accordion-level">
                <div class="card-body">
                    ...
                    ?>
                        ...
                        <div id="cemploye-poiuy-<?php echo $vemp->NIK; ?>" class="collapse collapse-content">
                            <table id="table-karyawan" class="table table-bordered table-input">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="input-group mb-3">
                                                        <input type="number" name="kpi_weight[<?php echo $vemp->NIK; ?>][<?php echo $vlj->id; ?>]" class="form-control" value="<?php echo $vlj->kpi_weight; ?>">
                                                ...
                                                @php
                                                $month_first = new DateTime($header->kpi_year_from."-".$header->kpi_month_from);
                                                for($j = 1; $j <= $diff_month; $j++): $kpi_value=(!empty( $details_by_key[$vemp->NIK][$vlj->id][ $month_first->format('Y')."-".$month_first->format('n')]->kpi_value ))
                                    ...
                                    <tr class="custom">
                                        ...
                                        <td>
                                            <div class="input-group mb-3">
                                                <input type="number" name="kpi_weight_custom[<?php echo $vemp->NIK; ?>]" class="form-control" value="">
                                                <div class="input-group-addon">
                                                    <span class="input-group-text">%</span>
                                                </div>
                                            </div>
                                        ...
                                        @php
                                        $month_first = new DateTime($header->kpi_year_from."-".$header->kpi_month_from);
                                        for($j = 1; $j <= $diff_month; $j++): $kpi_value='' ; // $kpi_value=(!empty( $details_by_key[$vlj->nik][$vlj->job_id][ $month_first->format('Y')."-". $month_first->format('n')]->kpi_value ))
                                            // ? $details_by_key[$vlj->nik][$vlj->job_id][ $month_first->format('Y')."-". $month_first->format('n')]->kpi_value : '';
                                            @endphp
                                            <td class="text-center input-value">
                                                <select name="kpi_value_custom[<?php echo $vemp->NIK; ?>]" class="form-control">
                                                    <option value="skip" {{ ($kpi_value == 'skip') ? 'selected' : '' }}> - </option>
                                                    <option value="1" {{ ($kpi_value == '1') ? 'selected' : '' }}> 1 </option>
                                                    <option value="2" {{ ($kpi_value == '2') ? 'selected' : '' }}> 2 </option>
                                                    <option value="3" {{ ($kpi_value == '3') ? 'selected' : '' }}> 3 </option>
